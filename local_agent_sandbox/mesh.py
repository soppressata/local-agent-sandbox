...
class TrustPolicy:
    ...
    def add_rule(self, rule: TrustRule) -> None:
...
class MeshNetworkManager:
    ...
    def __init__(self, ca: Optional[CertificateAuthority] = None):
        ...
        # Allow default mesh communication rule
        ...
        self.universe_certs: Dict[str, Tuple[bytes, bytes]] = {}  # universe_id -> (key_pem, cert_pem)
        self.channels: Dict[str, MeshChannel] = {}  # channel_id -> MeshChannel
        self.universe_connections: Dict[str, Set[str]] = {}  # universe_id -> Set[target_id]
